                ...
                <section class="section">
                    ...
                    <div class="card p-3">
                        ...
                        <div class="form-group">
                            ...
                            <input required class="form-control" type="text" name="name_prd">
                            <br><label>Giá</label>
                            <input required class="form-control" type="number" name="price_prd">
                            <br><label>Số lượng</label>
                            <input required class="form-control" type="number" name="amount_prd">
                            <br><label>Mô tả</label>
                            <textarea required id="editor" name="desc_prd"></textarea>
                            <br><label>Giảm giá</label>
                            <input class="form-control" type="number" name="discount_prd">
                            <br><label>Ảnh</label>
                        ...
                        <input type="submit" class="btn btn-info" name="create_prd" value="Thêm sản phẩm">
                        </form>
                        <?php
                       
                        if (isset($_POST['create_prd'])) {
                            ...
                            if($price_prd<0 || $amount_prd<0){
                                ...
                                \Cloudinary\Uploader::upload($tempfile, $options = array("public_id"=> $slug));
                                $img = cloudinary_url($slug);
                                $db->insertPrd($id_cate,$name_prd,$price_prd,$discount_prd,$img,$desc_prd,$amount_prd,$id_user);
